		...
		<div class="table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-sm-6">
							<h2>Manage <b>Computer Systems</b></h2>
						</div>

						<div class="col-sm-6">
							<a href="{{ route('issues.create') }}" class="btn btn-success"><i
									class="material-icons">&#xE147;</i> <span>Thêm vấn đề mới</span></a>
				...
				<table class="table table-striped table-hover">
					<thead>
						<tr>
							<th>Mã vấn đề báo cáo </th>
							<th>Thông tin máy</th>
							<th>Người báo cáo sự cố</th>
							<th>Thời gian báo cáo</th>
							<th>Mô tả chi tiết vấn đề</th>
							<th>Mức độ sự cố</th>
							<th>Trạng thái hiện tại của sự cố</th>
							<th>Hành động</th>
						</tr>
					</thead>
					<tbody>
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-body">
													Bạn có chắc chắn muốn xóa vấn đề này không? Hành động này không thể hoàn
													tác.
												</div>
...
{{-- <!-- Modal xác nhận xóa -->
<div class="modal fade" id="deleteModal{{ $thesis->id }}" tabindex="-1"
	aria-labelledby="deleteModalLabel{{ $thesis->id }}" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
